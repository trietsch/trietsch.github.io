...
{{< imageandtext img="/icons/gcp.svg" text="<a href=\"https://cloud.google.com/\" target=\"_blank\">GCP</a>: <b>expert</b></br>Cloud Functions, Cloud Run, Cloud SQL, Pub/Sub, GKE, Secrets Manager, Load Balancing, Cloud DNS, Cloud KMS, Cloud Storage, Stackdriver, Cloud Endpoints and more." >}}
...
{{< imageandtext img="/icons/git.svg" text="GitOps: <b>expert</b></br>Automate all the things. I am a big fan of automating infrastructure, because of predictability, portability, and maintainability." >}}
...
_Most icons are licensed under the [CC0 license](https://creativecommons.org/publicdomain/zero/1.0/) and belong to their respective owners. Those that are not, are accredited in [the credits section](/credits)._
